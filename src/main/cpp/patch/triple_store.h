...
public:
     ...
     * @param addition
     */
    void print_tree(TreeDB* tree, bool addition, DictionaryManager* dict);

    void purge_version_in_addition_tree(int version, TreeDB *tree, DictionaryManager* dict, bool write_to_file);
    void extract_additions(DictionaryManager* dict, std::string path);
    void extract_deletions(DictionaryManager* dict, std::string path);

    void purge_versions_in_deletions(int version, DictionaryManager *dict, bool write_to_file);

    void print_trees(DictionaryManager *dict);
};
