...
template<class DV>
void PatchTreeIteratorBase<DV>::setReverse_1(bool reverse_1) {
    PatchTreeIteratorBase::reverse_1 = reverse_1;
}

template<class DV>
PatchTreeKeyComparator *PatchTreeIteratorBase<DV>::getComparator() const {
    return comparator;
}
