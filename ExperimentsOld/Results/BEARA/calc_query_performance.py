...
while(True):
    ...
    o_dm_count_time_per_pattern, o_dm_res_time_per_pattern = process_delta_materialized_lines(next_n_lines(ostrich_query_file, 2 + number_of_delta_lines))
    ...
    c_dm_count_time_per_pattern, c_dm_res_time_per_pattern = process_delta_materialized_lines(next_n_lines(cobra_query_file, 2 + number_of_delta_lines))
